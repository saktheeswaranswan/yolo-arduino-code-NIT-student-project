...
ap.add_argument('-c', '--config', 
                help = 'path to yolo config file', default='yolov4-tiny.cfg')
ap.add_argument('-w', '--weights', 
                help = 'path to yolo pre-trained weights', default='yolov4-tiny.weights')
...
window_title= "speed break detector"   
